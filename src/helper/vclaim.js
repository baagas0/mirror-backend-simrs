...
function getBPJSnonDekrip (data){
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            const headers = await headerVclaim({ time: time })
    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            if (!respon.response) {
                ...
                const isi = respon.response
                const hasil_json = await decriptVclaim({ time, isi });
...
function postBPJS (data){
    return new Promise(async (resolve, reject) => {
        ...
        try {
            const time = moment().unix();
            const headers = await headerVclaim({ time })
...
module.exports = {decriptVclaim,headerVclaim,getBPJS,getBPJSnonDekrip,postBPJS,putBPJS,deleteBPJS}